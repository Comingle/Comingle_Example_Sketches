...
void setup()
{
  ...
  //Set OSSEX to be in Software Serial mode on the Hacker Port
  Toy.setID(BETA);
...
Serial.print("Heartbeat Reading  ");
    valstring =  getStringPartByNr(str, ',', 2);  // the third part - 0054
valstring.remove(4); //chop off the period at the end of the reported heartbeat
