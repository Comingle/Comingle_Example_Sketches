/*
 * Modified for Comingle
This library works better than the one that uses nunchuck_funcs.h because it does not lock Z and C buttons in the knockoff remotes 
